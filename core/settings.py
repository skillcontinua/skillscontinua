...
# --- DATABASE - PYTHON + POSTGRESQL FOR TWO PROJECTS ---
# 1. Production (Render/DigitalOcean) uses env vars
# 2. Local PostgreSQL for XAMPP / Ubuntu i7
# 3. Fallback SQLite if PostgreSQL not installed yet
...
if os.environ.get('DB_HOST'):
    ...
    try:
        ...
        # Fallback SQLite if psycopg2 not installed yet
        DATABASES = {
            'default': {
