...
CSRF_TRUSTED_ORIGINS = [
    ...
    'http://localhost:8000', 
    'https://*.onrender.com',
    'https://skillscontinua.com',
    'https://www.skillscontinua.com'
]
...
# Get LIVE keys from https://dashboard.paystack.com/#/settings/developer after KYC